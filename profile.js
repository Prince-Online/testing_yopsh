const fetchUrl = 'https://script.google.com/macros/s/AKfycbwzvAtV9byBHvy_ymTMOwbWO06SIW31-htxBBBopRpEDLkP53uHxkNzjmCQVGAzMA/exec';
...
function displayUserDetails(user) {
  ...
  document.getElementById('userBoss').innerText = user.username;
